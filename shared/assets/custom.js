...
class CollapsibleGrids {
  ...
  static #getCardsPerRow(gridElement) {
    ...
    let minCardWidth = this.#parsePx(
      style.getPropertyValue("--min-card-width"),
    );
...
class YoutubeProgress {
  static #config = {
    api: "https://pb.kod.run/api/collections/{collection}/records",
    records: "https://pb.kod.run/youtube-progress",
    collection: "youtube",
    selectors: {
